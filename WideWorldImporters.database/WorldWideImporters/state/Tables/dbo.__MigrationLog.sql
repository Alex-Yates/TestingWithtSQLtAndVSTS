...
[script_checksum] [nvarchar] (64) COLLATE Latin1_General_100_CI_AS NOT NULL,
[script_filename] [nvarchar] (255) COLLATE Latin1_General_100_CI_AS NOT NULL,
[complete_dt] [datetime2] NOT NULL,
[applied_by] [nvarchar] (100) COLLATE Latin1_General_100_CI_AS NOT NULL,
[deployed] [tinyint] NOT NULL CONSTRAINT [DF___MigrationLog_deployed] DEFAULT ((1)),
[version] [varchar] (255) COLLATE Latin1_General_100_CI_AS NULL,
[package_version] [varchar] (255) COLLATE Latin1_General_100_CI_AS NULL,
[release_version] [varchar] (255) COLLATE Latin1_General_100_CI_AS NULL,
[sequence_no] [int] NOT NULL IDENTITY(1, 1)
) ON [USERDATA]
GO
ALTER TABLE [dbo].[__MigrationLog] ADD CONSTRAINT [PK___MigrationLog] PRIMARY KEY CLUSTERED  ([migration_id], [complete_dt], [script_checksum]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [IX___MigrationLog_CompleteDt] ON [dbo].[__MigrationLog] ([complete_dt]) ON [USERDATA]
GO
CREATE UNIQUE NONCLUSTERED INDEX [UX___MigrationLog_SequenceNo] ON [dbo].[__MigrationLog] ([sequence_no]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [IX___MigrationLog_Version] ON [dbo].[__MigrationLog] ([version]) ON [USERDATA]
GO
